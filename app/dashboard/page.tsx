        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="p-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
              title="Sign out"
            >
          ...
          <div className="mb-4 rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20 p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-blue-800 dark:text-blue-300">
                Configure an AI provider before creating your first classroom.
              </span>
            </div>
            <button
              onClick={() => router.push("/settings")}
              className="shrink-0 ml-4 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 transition-colors whitespace-nowrap"
            >
              Configure AI Stack →
            </button>
          </div>
        ...
        {classrooms.length === 0 && !error && (
          <div className="rounded-xl border border-dashed border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-8 text-center shadow-sm sm:p-12">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
              ...
              <button
                onClick={() => router.push("/catalog")}
                className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-5 py-2.5 text-sm font-medium transition-colors hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-gray-200"
              >
                Browse Open Classrooms
              </button>
            </div>
          </div>
        )}
