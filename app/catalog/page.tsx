        ...
        {classrooms.length === 0 ? (
          <div className="rounded-xl border border-dashed border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-12 text-center">
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              Instructors haven&apos;t published any public classrooms yet. Ask your instructor for a classroom code to join directly.
            </p>
              ...
              return (
                <div key={classroom.id} className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="shrink-0 rounded-full bg-green-100 dark:bg-green-900/30 px-2 py-0.5 text-[10px] font-medium text-green-700 dark:text-green-400 capitalize">
                    ...
                    {isEnrolled ? (
                      <div className="flex gap-2">
                        ...
                        <button onClick={() => router.push(`/classroom/${classroom.id}`)}
                          className="flex-1 rounded-lg bg-primary px-3 py-2 text-xs font-medium text-primary-foreground transition-colors hover:bg-primary/90">Open</button>
                      </div>
                    ) : (
                      <button onClick={() => handleEnroll(classroom.id)} disabled={isEnrolling}
